...
X_USER_ID = "YOUR_ENCRYPTED_USER_ID_HERE"  # format: encryptedData:iv
DONOR_PROFILE_ID = "YOUR_DONOR_PROFILE_OBJECTID_HERE"
...
metadata_auctions = {
    ...
    "get_my_bid_history": {
        ...
        "type": "lookup",
        "when_to_use": (
            "When user asks about their bids, bid history, bid status, or which auctions they have bid on. "
            "Trigger phrases: 'my bids', 'bid history', 'show my bids', 'what have I bid on', "
            "'am I winning', 'my auction activity'."
        ),
        "do_not_use": (
    ...
    "place_bid": {
        ...
        "when_to_use": (
            ...
            "Both auction_id AND amount must be known before calling this tool."
        ),
        "do_not_use": (
    ...
    "get_charities_by_donation_type": {
        ...
        "hint": (
            ...
            "- If user selects a category by number (e.g. '2'), resolve the _id from session cache first.\n"
...
if __name__ == "__main__":
    ...
    # Try to extract an auction_id for subsequent tests
    auction_id = None
    try:
    ...
    if auction_id:
        ...
        print("\nSkipping TEST 2 — no auction_id found.\n")
    ...
    # Try to extract a donation_type_id for next test
